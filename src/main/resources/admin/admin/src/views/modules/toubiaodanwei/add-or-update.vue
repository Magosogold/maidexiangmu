	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="投标级别" prop="toubiaojibie">
					<el-select :disabled="ro.toubiaojibie" v-model="ruleForm.toubiaojibie" placeholder="请选择投标级别" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="投标级别" prop="toubiaojibie">
					<el-input v-model="ruleForm.toubiaojibie"
						placeholder="投标级别" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="经营范围" prop="jingyingfanwei">
					<el-input v-model="ruleForm.jingyingfanwei" placeholder="经营范围" clearable  :readonly="ro.jingyingfanwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="经营范围" prop="jingyingfanwei">
					<el-input v-model="ruleForm.jingyingfanwei" placeholder="经营范围" readonly></el-input>
				</el-form-item>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `toubiaodanwei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.toubiaodanweiCrossAddOrUpdateFlag = false;
						 this.parent.search();
