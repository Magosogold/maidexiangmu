<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="归档单号" prop="guidangdanhao">
					<el-input v-model="ruleForm.guidangdanhao" placeholder="归档单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.guidangdanhao" label="归档单号" prop="guidangdanhao">
					<el-input v-model="ruleForm.guidangdanhao" placeholder="归档单号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="评标情况" prop="pingbiaoqingkuang">
					<el-input v-model="ruleForm.pingbiaoqingkuang" placeholder="评标情况" clearable  :readonly="ro.pingbiaoqingkuang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="评标情况" prop="pingbiaoqingkuang">
					<el-input v-model="ruleForm.pingbiaoqingkuang" placeholder="评标情况" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.guidangwenjian" label="归档文件" prop="guidangwenjian">
					<file-upload
						tip="点击上传归档文件"
						action="file/upload"
						:limit="1"
						:multiple="true"
						:fileUrls="ruleForm.guidangwenjian?ruleForm.guidangwenjian:''"
						@change="guidangwenjianUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.guidangwenjian" label="归档文件" prop="guidangwenjian">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#93C7B3","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.guidangwenjian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.guidangwenjian" label="归档文件" prop="guidangwenjian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="归档日期" prop="guidangriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.guidangriqi" 
						type="date"
						:readonly="ro.guidangriqi"
						placeholder="归档日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.guidangriqi" label="归档日期" prop="guidangriqi">
					<el-input v-model="ruleForm.guidangriqi" placeholder="归档日期" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="归档说明" prop="guidangshuoming">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="归档说明"
					  v-model="ruleForm.guidangshuoming" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.guidangshuoming" label="归档说明" prop="guidangshuoming">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.guidangshuoming}}</span>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				...
				toubiaodanwei : false,
				guidangwenjian : false,
				guidangshuoming : false,
				guidangriqi : false,
				crossuserid : false,
				crossrefid : false,
			},
	...
	created() {
		this.ruleForm.guidangriqi = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='guidangdanhao'){
							this.ruleForm.guidangdanhao = obj[o];
							this.ro.guidangdanhao = true;
							continue;
						}
						...
						if(o=='guidangwenjian'){
							this.ruleForm.guidangwenjian = obj[o];
							this.ro.guidangwenjian = true;
							continue;
						}
						if(o=='guidangshuoming'){
							this.ruleForm.guidangshuoming = obj[o];
							this.ro.guidangshuoming = true;
							continue;
						}
						if(o=='guidangriqi'){
							this.ruleForm.guidangriqi = obj[o];
							this.ro.guidangriqi = true;
							continue;
						}
						if(o=='crossuserid'){
	...
	if(this.ruleForm.guidangwenjian!=null) {
		this.ruleForm.guidangwenjian = this.ruleForm.guidangwenjian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `guidangbaocun/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.guidangbaocunCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    guidangwenjianUploadChange(fileUrls) {
	    this.ruleForm.guidangwenjian = fileUrls;
    },
  }
};
</script>
