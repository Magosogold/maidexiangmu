	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="联系人" prop="lianxiren">
					<el-input v-model="ruleForm.lianxiren" placeholder="联系人" clearable  :readonly="ro.lianxiren"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="联系人" prop="lianxiren">
					<el-input v-model="ruleForm.lianxiren" placeholder="联系人" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.zhaobiaozige" label="招标资格" prop="zhaobiaozige">
					<file-upload
						tip="点击上传招标资格"
						action="file/upload"
						:limit="1"
						...
						@change="zhaobiaozigeUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.zhaobiaozige" label="招标资格" prop="zhaobiaozige">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#93C7B3","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.zhaobiaozige)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.zhaobiaozige" label="招标资格" prop="zhaobiaozige">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="办公地址" prop="bangongdizhi">
					<el-input v-model="ruleForm.bangongdizhi" placeholder="办公地址" clearable  :readonly="ro.bangongdizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="办公地址" prop="bangongdizhi">
					<el-input v-model="ruleForm.bangongdizhi" placeholder="办公地址" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zhaobiaozige'){
							this.ruleForm.zhaobiaozige = obj[o];
							this.ro.zhaobiaozige = true;
							continue;
						}
						if(o=='zixundianhua'){
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhaobiaodanwei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhaobiaodanweiCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    zhaobiaozigeUploadChange(fileUrls) {
